 ...
 * @security bearer
 */
  .get(checkPermission('list',['admin']),wrapper(listController.getAll.bind(listController)))
  /**
   * POST /lists
...
router.route('/:id')
   ...
   * @security bearer
   * */
  .get(checkPermission('list',['admin','collaborator','owner']),wrapper(listController.getOne.bind(listController)))
